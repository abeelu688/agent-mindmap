...
For path `/home/welde/cursor/airecorder`, Cursor uses slug `home-welde-cursor-airecorder` (path without leading `/`, slashes → `-`):

`~/.cursor/projects/home-welde-cursor-airecorder/agent-transcripts/<uuid>/<uuid>.jsonl`

For `/home/welde/cursor/aosp14` → `home-welde-cursor-aosp14`.
