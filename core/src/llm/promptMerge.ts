import { OUTLINE_PROMPT_VERSION } from "./promptOutline";
...
export const MERGE_PROMPT_VERSION = OUTLINE_PROMPT_VERSION;
...
export const __testingPromptMerge = { renderRecord, clip, renderOutlineNode };
