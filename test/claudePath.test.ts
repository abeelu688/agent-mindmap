...
describe("encodeClaudeProjectPath", () => {
  it("encodes unix absolute paths with a leading dash", () => {
    expect(encodeClaudeProjectPath("/home/example/cursor/airecorder")).toBe(
...
describe("decodeClaudeProjectPath", () => {
  it("round-trips simple unix paths", () => {
    const enc = encodeClaudeProjectPath("/home/example/proj");
    expect(decodeClaudeProjectPath(enc)).toBe("/home/example/proj");
  });
});
